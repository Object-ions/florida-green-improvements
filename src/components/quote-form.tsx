  ...
  return (
    <form onSubmit={onSubmit} onInput={onFirstInput} noValidate className="flex flex-col gap-7">
      ...
      <button
        ...
        className="mt-2 self-start bg-amber px-9 py-4 font-data text-[12px] font-medium uppercase tracking-[0.1em] text-on-amber transition-opacity hover:opacity-90 disabled:opacity-50"
      >
